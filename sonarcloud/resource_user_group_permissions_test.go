		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("sonarcloud_user_group_permissions.test_permission", "project", ""),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("sonarcloud_user_group_permissions.test_permission", "project", project),
					resource.TestCheckResourceAttr("sonarcloud_user_group_permissions.test_permission", "group", group),
